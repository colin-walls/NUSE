...
typedef U8 NU_TASK;             /* kernel object index data types */
typedef U8 NU_PARTITION_POOL;
typedef U8 NU_MAILBOX;
typedef U8 NU_QUEUE;
typedef U8 NU_PIPE;
typedef U8 NU_SEMAPHORE;
typedef U8 NU_EVENT_GROUP;
typedef U8 NU_TIMER;
